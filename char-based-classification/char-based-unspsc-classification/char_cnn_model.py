...
def model(filter_kernels, dense_outputs, maxlen, vocab_size, filters, unit_output):
    ...
    conv2 = Convolution1D(filters=filters[2], kernel_size=filter_kernels[2],
                          padding='same', activation='relu')(conv1)

    conv3 = Convolution1D(filters=filters[3], kernel_size=filter_kernels[3],
    ...
    conv5 = MaxPooling1D(pool_size=2)(conv3)
    conv5 = Flatten()(conv5)
